    ...
    return (
      <div className="flex w-full flex-col gap-2">
        ...
        <input
          ...
          id={inputId}
          className={cn(
            "w-full rounded-3xl border border-white/[0.08] bg-[var(--sd-input-bg)] px-4 py-3 text-sm text-foreground placeholder:text-zinc-500 light:border-zinc-200/90 light:placeholder:text-zinc-500",
